		...
		<div class="row">
			...
			<div class="col-xs-10">
				<ul class="nav nav-tabs" id="nav">
					...
					<li><a class="dropdown-toggle" href="/board">홈페이지
					...
					<li><a class="dropdown-toggle" href="/consulting">상담 <span
						...
						<ul class="dropdown-menu">
							<li><a href="/consulting/manager/list">상담
									신청 내역 조회</a></li>
							<li><a href="/consulting/student/apply">상담 신청</a></li>
							<li><a href="/consulting/manager/regist">상담
									등록</a></li>
						</ul></li>
					<li><a class="dropdown-toggle" href="/user/student">계정 관리
