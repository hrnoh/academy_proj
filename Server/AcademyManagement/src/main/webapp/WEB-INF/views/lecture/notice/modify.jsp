			...
			<div class="col-xs-10 text-left">
				  ...
				  <div class="panel panel-default">
					  ...
					  <form class="form-horizontal" id="myForm" method="post">
					  	  ...
					  	  <input type="hidden" name="uno" value="${noticeVO.uno }">
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-xs-10">
								 <input type="text" class="form-control" name="title" value="${noticeVO.title }">
							</div>
						  </div>
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-xs-10">
								 <textarea class="form-control" rows="10" name="content">${noticeVO.content }</textarea>
							</div>
						  </div>
...
<script>
	$(document).ready(function(){
		$("#cancelBtn ").on("click", function(){
			self.location = "/lecture/notice/list?page=${cri.page}&perPageNum=${cri.perPageNum}" + 
					"&lno=${noticeVO.lno}&lname=${noticeVO.lname}";
		});
